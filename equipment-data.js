...
// ── FIREARMS ──────────────────────────────────────────────────────────────────
{
  ...
  system: { name: '', description: '<p><em>Revolver capacity: 6. Examples: .22 LR, .32 ACP, .380 ACP, .38 Special: S&amp;W Model 36, Walther PPK.</em></p>', skill: 'firearms', skillModifier: 0, customSkillTarget: 50, range: '10M', damage: '1D8', armorPiercing: 0, lethality: null, isLethal: false, killRadius: 'N/A', ammo: '7', expense: 'Standard', equipped: true }
},
{
  category: 'Firearms', name: 'Medium pistol', type: 'weapon',
  img: 'systems/deltagreen/assets/icons/pistol.svg', flags: {}, effects: [],
  system: { name: '', description: '<p><em>Revolver capacity: 6. Examples: 9×19 mm, .40 S&amp;W, .45 ACP: Beretta Mod 92FS (M9), Colt M1911A1, Glock 17, Glock 22.</em></p>', skill: 'firearms', skillModifier: 0, customSkillTarget: 50, range: '15M', damage: '1D10', armorPiercing: 0, lethality: null, isLethal: false, killRadius: 'N/A', ammo: '15', expense: 'Standard', equipped: true }
},
{
  category: 'Firearms', name: 'Heavy pistol', type: 'weapon',
  img: 'systems/deltagreen/assets/icons/pistol.svg', flags: {}, effects: [],
  system: { name: '', description: '<p><em>Revolver capacity: 6. Examples: .357 Magnum, .44 Magnum, .50 AE: Colt Delta Elite, Glock 20, S&amp;W Model 13.</em></p>', skill: 'firearms', skillModifier: 0, customSkillTarget: 50, range: '20M', damage: '1D12', armorPiercing: 0, lethality: null, isLethal: false, killRadius: 'N/A', ammo: '10', expense: 'Standard', equipped: true }
},
{
...
},
{
  ...
  system: { name: '', description: '<p><em>Half damage beyond base range. Includes +20% bonus for firing shot. Examples: Mossberg Model 500, Remington Model 870.</em></p>', skill: 'firearms', skillModifier: 20, customSkillTarget: 50, range: '75M', damage: '2D8', armorPiercing: 0, lethality: null, isLethal: false, killRadius: 'N/A', ammo: '5', expense: 'Standard', equipped: true }
},
{
  category: 'Firearms', name: 'Shotgun (firing slug)', type: 'weapon',
  img: 'systems/deltagreen/assets/icons/shotgun.svg', flags: {}, effects: [],
  system: { name: '', description: '<p><em>Damage reduced to 2D6 beyond base range.</em></p>', skill: 'firearms', skillModifier: 0, customSkillTarget: 50, range: '75M', damage: '2D8', armorPiercing: 0, lethality: null, isLethal: false, killRadius: 'N/A', ammo: '5', expense: 'Standard', equipped: true }
},
{
  category: 'Firearms', name: 'Shotgun (firing nonlethal)', type: 'weapon',
  img: 'systems/deltagreen/assets/icons/shotgun.svg', flags: {}, effects: [],
  system: { name: '', description: '<p><strong>Damage:</strong> 1D6 and Stunned</p>', skill: 'firearms', skillModifier: 0, customSkillTarget: 50, range: '10M', damage: '1D6', armorPiercing: 0, lethality: null, isLethal: false, killRadius: 'N/A', ammo: '5', expense: 'Standard', equipped: true }
},
...
// ── MELEE WEAPONS ─────────────────────────────────────────────────────────────
{
  ...
  system: { name: '', description: '', skill: 'unarmed_combat', skillModifier: 0, customSkillTarget: 50, range: '1M', damage: '1D4-1', armorPiercing: 0, lethality: null, isLethal: false, killRadius: 'N/A', ammo: '', expense: 'NA', equipped: true }
},
{
...
},
{
  ...
  system: { name: '', description: '', skill: 'melee_weapons', skillModifier: 0, customSkillTarget: 50, range: '1M', damage: '1D6', armorPiercing: 3, lethality: null, isLethal: false, killRadius: 'N/A', ammo: '', expense: 'Incidental', equipped: true }
},
{
  category: 'Melee Weapons', name: 'Hatchet', type: 'weapon',
  img: 'systems/deltagreen/assets/icons/hatchet.svg', flags: {}, effects: [],
  system: { name: '', description: '', skill: 'melee_weapons', skillModifier: 0, customSkillTarget: 50, range: '1M', damage: '1D4', armorPiercing: 0, lethality: null, isLethal: false, killRadius: 'N/A', ammo: '', expense: 'Incidental', equipped: true }
},
{
  ...
  system: { name: '', description: '', skill: 'melee_weapons', skillModifier: 0, customSkillTarget: 50, range: '1M', damage: '1D6', armorPiercing: 0, lethality: null, isLethal: false, killRadius: 'N/A', ammo: '', expense: 'Incidental', equipped: true }
},
{
  ...
  system: { name: '', description: '', skill: 'melee_weapons', skillModifier: 0, customSkillTarget: 50, range: '1M', damage: '1D8', armorPiercing: 0, lethality: null, isLethal: false, killRadius: 'N/A', ammo: '', expense: 'Incidental', equipped: true }
},
{
...
},
{
  ...
  system: { name: '', description: '', skill: 'melee_weapons', skillModifier: 0, customSkillTarget: 50, range: '1M', damage: '1D8', armorPiercing: 3, lethality: null, isLethal: false, killRadius: 'N/A', ammo: '', expense: 'Incidental', equipped: true }
},
{
  category: 'Melee Weapons', name: 'Wood axe', type: 'weapon',
  img: 'systems/deltagreen/assets/icons/wood-axe.svg', flags: {}, effects: [],
  system: { name: '', description: '', skill: 'melee_weapons', skillModifier: 0, customSkillTarget: 50, range: '1M', damage: '1D10', armorPiercing: 0, lethality: null, isLethal: false, killRadius: 'N/A', ammo: '', expense: 'Incidental', equipped: true }
},
{
  category: 'Melee Weapons', name: 'Long sword', type: 'weapon',
  img: 'systems/deltagreen/assets/icons/long-sword.svg', flags: {}, effects: [],
  system: { name: '', description: '', skill: 'melee_weapons', skillModifier: 0, customSkillTarget: 50, range: '1M', damage: '1D10', armorPiercing: 0, lethality: null, isLethal: false, killRadius: 'N/A', ammo: '', expense: 'Standard', equipped: true }
},
{
  ...
  system: { name: '', description: '<p><em>Requires special training.</em></p>', skill: 'melee_weapons', skillModifier: 0, customSkillTarget: 50, range: '1M', damage: '1D12', armorPiercing: 0, lethality: null, isLethal: false, killRadius: 'N/A', ammo: '', expense: 'Standard', equipped: true }
},
...
{
  category: 'Heavy Weapons', name: 'General-purpose machine gun (GPMP)', type: 'weapon',
  img: 'systems/deltagreen/assets/icons/machine-gun.svg', flags: {}, effects: [],
...
},
{
  ...
  img: 'systems/deltagreen/assets/icons/machine-gun.svg', flags: {}, effects: [],
  system: { name: '', description: '<p><em><strong>RESTRICTED.</strong> Examples: Browning M2HB, Degtyaryov DShKM, Kovrov NSV.</em></p>', skill: 'firearms', skillModifier: 0, customSkillTarget: 50, range: '400M', damage: '', armorPiercing: 5, lethality: 20, isLethal: true, killRadius: '1M', ammo: '100', expense: 'Major', equipped: true }
},
{
...
},
{
  ...
  system: { name: '', description: '<p><em><strong>RESTRICTED.</strong> Example: M112. Includes +20% blast-zone bonus.</em></p>', skill: 'demolitions', skillModifier: 20, customSkillTarget: 50, range: '', damage: '', armorPiercing: 0, lethality: 30, isLethal: false, killRadius: '2M', ammo: '', expense: 'Incidental', equipped: true }
},
{
...
// ── LESS-LETHAL ───────────────────────────────────────────────────────────────
{
  ...
  system: { name: '', description: '<p><em><strong>Victim\'s Penalty:</strong> \u221220% for 1D20 turns</em></p>', skill: 'dex', skillModifier: 0, customSkillTarget: 50, range: '1M', damage: '', armorPiercing: 0, lethality: null, isLethal: false, killRadius: 'N/A', ammo: '10', expense: 'Incidental', equipped: true }
},
{
  category: 'Less-Lethal', name: 'Shock baton', type: 'weapon',
  img: 'systems/deltagreen/assets/icons/electroshock.svg', flags: {}, effects: [],
  system: { name: '', description: '<p><em><strong>Victim\'s Penalty:</strong> \u221220% for 1D20 turns</em></p>', skill: 'dex', skillModifier: 0, customSkillTarget: 50, range: '1M', damage: '', armorPiercing: 0, lethality: null, isLethal: false, killRadius: 'N/A', ammo: '200', expense: 'Incidental', equipped: true }
},
{
  category: 'Less-Lethal', name: 'CED pistol', type: 'weapon',
  img: 'systems/deltagreen/assets/icons/electroshock.svg', flags: {}, effects: [],
  system: { name: '', description: '<p><em>Requires special training. <strong>Victim\'s Penalty:</strong> \u221220% for 1D20 turns</em></p>', skill: 'firearms', skillModifier: 0, customSkillTarget: 50, range: '4M', damage: '', armorPiercing: 0, lethality: null, isLethal: false, killRadius: 'N/A', ammo: '4', expense: 'Standard', equipped: true }
},
{
...
},
{
  ...
  system: { name: '', description: '<p><em><strong>Restricted.</strong> Requires special training. Radius: 10 m. <strong>Victim\'s Penalty:</strong> \u221240% for 1 hr</em></p>', skill: 'athletics', skillModifier: 0, customSkillTarget: 50, range: '20M', damage: '', armorPiercing: 0, lethality: null, isLethal: false, killRadius: '10M', ammo: '1', expense: 'Standard', equipped: true }
},
{
  category: 'Less-Lethal', name: 'Tear gas grenade, launched', type: 'weapon',
  img: 'systems/deltagreen/assets/icons/tear-gas-grenade.svg', flags: {}, effects: [],
  system: { name: '', description: '<p><em><strong>Restricted. Radius:</strong> 10 m. <strong>Victim\'s Penalty:</strong> \u221240% for 1 hr</em></p>', skill: 'heavy_weapons', skillModifier: 0, customSkillTarget: 50, range: '50M', damage: '', armorPiercing: 0, lethality: null, isLethal: false, killRadius: '10M', ammo: '1', expense: 'Standard', equipped: true }
},
{
  ...
  system: { name: '', description: '<p><em>Radius: 1 target. <strong>Victim\'s Penalty:</strong> \u221220% for 1 hr</em></p>', skill: 'dex', skillModifier: 0, customSkillTarget: 50, range: '1M', damage: '', armorPiercing: 0, lethality: null, isLethal: false, killRadius: 'N/A', ammo: '1', expense: 'Incidental', equipped: true }
},
{
  ...
  system: { name: '', description: '<p><em>Radius: 2 targets. <strong>Victim\'s Penalty:</strong> \u221220% for 1 hr</em></p>', skill: 'dex', skillModifier: 0, customSkillTarget: 50, range: '3M', damage: '', armorPiercing: 0, lethality: null, isLethal: false, killRadius: 'N/A', ammo: '12', expense: 'Incidental', equipped: true }
},
...
{
  category: 'Survival & Medical', name: 'Small fire extinguisher (C02)', type: 'gear',
